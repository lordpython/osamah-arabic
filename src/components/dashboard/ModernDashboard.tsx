    ...
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <MetricCard title="Active Drivers" value={62} icon="🚗" trend={5} theme="dark" />
          <MetricCard title="Monthly Revenue" value={84500} icon="💰" trend={12} format="currency" theme="dark" />
          <MetricCard title="Performance" value={72} icon="📈" trend={-3} format="percentage" theme="dark" />
          <MetricCard title="Fleet Utilization" value={89} icon="🚚" trend={7} format="percentage" theme="dark" />
        </div>
